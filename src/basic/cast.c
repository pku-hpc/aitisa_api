...
static Status cast_template(const Tensor input, DataType out_dtype,
  ...
  switch (in_dtype.code) {
    case TYPE_INT8: {
      AITISA_DISPATCH_ALL_TYPES_WITH_ARGS_RETURN(out_dtype, cast_kernel, int8_t, in_data,
                                                 out_data, size);
      break;
    }
    case TYPE_UINT8: {
      AITISA_DISPATCH_ALL_TYPES_WITH_ARGS_RETURN(out_dtype, cast_kernel, uint8_t, in_data,
                                                 out_data, size);
      break;
    }
    case TYPE_INT16: {
      AITISA_DISPATCH_ALL_TYPES_WITH_ARGS_RETURN(out_dtype, cast_kernel, int16_t, in_data,
                                                 out_data, size);
      break;
    }
    case TYPE_UINT16: {
      AITISA_DISPATCH_ALL_TYPES_WITH_ARGS_RETURN(out_dtype, cast_kernel, uint16_t, in_data,
                                                 out_data, size);
      break;
    }
    case TYPE_INT32: {
      AITISA_DISPATCH_ALL_TYPES_WITH_ARGS_RETURN(out_dtype, cast_kernel, int32_t, in_data,
                                                 out_data, size);
      break;
    }
    case TYPE_UINT32: {
      AITISA_DISPATCH_ALL_TYPES_WITH_ARGS_RETURN(out_dtype, cast_kernel, uint32_t, in_data,
                                                 out_data, size);
      break;
    }
    case TYPE_INT64: {
      AITISA_DISPATCH_ALL_TYPES_WITH_ARGS_RETURN(out_dtype, cast_kernel, int64_t, in_data,
                                                 out_data, size);
      break;
    }
    case TYPE_UINT64: {
      AITISA_DISPATCH_ALL_TYPES_WITH_ARGS_RETURN(out_dtype, cast_kernel, uint64_t, in_data,
                                                 out_data, size);
      break;
    }
    case TYPE_FLOAT: {
      AITISA_DISPATCH_ALL_TYPES_WITH_ARGS_RETURN(out_dtype, cast_kernel, float, in_data,
                                                 out_data, size);
      break;
    }
    case TYPE_DOUBLE: {
      AITISA_DISPATCH_ALL_TYPES_WITH_ARGS_RETURN(out_dtype, cast_kernel, double, in_data,
                                                 out_data, size);
      break;
    }
    default:
