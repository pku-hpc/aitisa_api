...
execute_process(
  COMMAND "/usr/bin/git" show-ref v1.8.x
  WORKING_DIRECTORY "/gpfs/share/home/1801213993/aitisa_api/third_party/gtest/gtest-src"
...
if("${show_ref_output}" MATCHES "refs/remotes/v1.8.x")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "v1.8.x")
...
# yet).
execute_process(
  COMMAND "/usr/bin/git" rev-list --max-count=1 v1.8.x
  WORKING_DIRECTORY "/gpfs/share/home/1801213993/aitisa_api/third_party/gtest/gtest-src"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/gpfs/share/home/1801213993/aitisa_api/third_party/gtest/gtest-src/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/gpfs/share/home/1801213993/aitisa_api/third_party/gtest/gtest-src/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
    execute_process(
      COMMAND "/usr/bin/git" checkout v1.8.x
      WORKING_DIRECTORY "/gpfs/share/home/1801213993/aitisa_api/third_party/gtest/gtest-src"
      RESULT_VARIABLE error_code
      )
    if(error_code)
