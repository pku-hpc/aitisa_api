...
TEST(Pooling1D, AvgFloatK2S2P1D1) {
	...
	float* output_data = (float*)aitisa_tensor_data(output);
	int64_t output_size = aitisa_tensor_size(output);
	float test_data[] = { 0.0500, 0.2500, 0.4500, 0.6500, 0.4000,
                        0.9500, 1.1500, 1.3500, 1.5500, 0.8500,
                        1.8500, 2.0500, 2.2500, 2.4500, 1.3000,
                              2.7500, 2.9500, 3.1500, 3.3500, 1.7500,
                              3.6500, 3.8500, 4.0500, 4.2500, 2.2000,
                              4.5500, 4.7500, 4.9500, 5.1500, 2.6500 };
...
TEST(Pooling2D, MaxDoubleK6S6P3D1) {
  ...
  //tensor_printer2d(output);
	...
	int64_t output_size = aitisa_tensor_size(output);
	double test_data[] = { 6.4000,  7.0000,  7.4000,
                        15.4000, 16.0000, 16.4000,
                        21.4000, 22.0000, 22.4000,
                                 28.9000, 29.5000, 29.9000,
                                 37.9000, 38.5000, 38.9000,
                                 43.9000, 44.5000, 44.9000 };
